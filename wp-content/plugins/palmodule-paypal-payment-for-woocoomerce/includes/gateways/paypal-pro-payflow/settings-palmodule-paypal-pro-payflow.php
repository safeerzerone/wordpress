...
return $this->form_fields = array(
    'enabled' => array(
        ...
        'label' => __('Enable PayPal Pro Payflow Edition', 'palmodule-paypal-payment-for-woocoomerce'),
        'type' => 'checkbox',
        'description' => '',
        'default' => 'no'
    ),
    ...
    'debug' => array(
        ...
        'default' => 'no',
        'desc_tip' => true,
        'description' => __('Log PayPal Pro (Payflow) events inside <code>woocommerce/logs/paypal-pro-payflow.txt</code>', 'palmodule-paypal-payment-for-woocoomerce'),
    )
);
