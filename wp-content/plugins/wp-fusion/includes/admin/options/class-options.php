...
" id="<?php echo esc_attr( $section_slug ); ?>">
			...
			<p class="submit"><input name="Submit" type="submit" class="button-primary" <?php disabled( empty( $this->options['connection_configured'] ) ); ?> value="<?php esc_attr_e( 'Save Changes', 'wp-fusion' ); ?>" /></p>
		</form>
