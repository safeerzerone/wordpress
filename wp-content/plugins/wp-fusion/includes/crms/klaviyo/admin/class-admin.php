...
class WPF_Klaviyo_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		if ( has_filter( 'wpf_get_setting_klaviyo_key' ) ) {
			...
			$new_settings['klaviyo_auth'] = array(
				...
				'slug'    => $this->slug,
				// Translators: %s is the name of the CRM.
				'desc'    => sprintf( __( 'You\'ll be taken to %1$s to authorize WP Fusion and generate access keys for this site.', 'wp-fusion' ), $this->crm->name, '<a href="https://www.klaviyo.com/">', '</a>' ),
			);
	...
	private function show_revoke_confirmation_page( $connection_id, $return_url ) {
		...
		<body>
			<div class="container">
				<h1><?php esc_html_e( 'Revoke Klaviyo Connection', 'wp-fusion' ); ?></h1>
				<p><?php esc_html_e( 'Are you sure you want to revoke the connection to Klaviyo? This will:', 'wp-fusion' ); ?></p>
				<ul>
					<li><?php esc_html_e( 'Remove all stored access tokens', 'wp-fusion' ); ?></li>
					<li><?php esc_html_e( 'Disable the Klaviyo integration', 'wp-fusion' ); ?></li>
