	...
	public function handle_http_response( $response, $args, $url ) {
		...
		if ( strpos( $url, 'brevo' ) !== false && $args['user-agent'] == 'WP Fusion; ' . home_url() ) {
			...
			if ( isset( $body_json->error ) ) {
				...
				$response = new WP_Error( 'error', __( 'API key does not have sufficient permissions for this request. Please regenerate your API key in Brevo with all required access scopes enabled.', 'wp-fusion' ) );
