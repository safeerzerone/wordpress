...
class WPF_MemberPress_Admin {
	...
	private function get_membership_tag_settings() {
		return array(
			...
			'remove_tags_subaccount_removed' => array(
				'type'        => 'checkbox',
				'label'       => __( 'Remove Tags When Sub-Account Removed', 'wp-fusion' ),
				'description' => __( 'Remove tags applied to sub accounts (above) when the sub-account is removed from the corporate account.', 'wp-fusion' ),
				'show_if'     => 'MPCA_PLUGIN_NAME',
				'default'     => false,
			),
		);
