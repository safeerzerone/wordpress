...
class WPF_WPBakery extends WPF_Integrations_Base {
	...
	/**
	 * Get the attributes for the shortcodes.
	 *
	 * @since 3.46.6
	 *
	...
	private function get_shortcodes() {
		...
		$shortcodes_cache = get_transient( 'wpf_wpbakery_shortcodes' );

		if ( $shortcodes_cache ) {
			return $shortcodes_cache;
		}
		...
		set_transient( 'wpf_wpbakery_shortcodes', $file_names, 60 * 60 * 24 );
