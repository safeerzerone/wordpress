...
class WPF_Download_Monitor extends WPF_Integrations_Base {
	 ...
	 * CRM tags. Respects both the Filter Members Only setting and the global
	 * Filter Queries setting.
	 *
	 * @since  3.38.9
	 *
	...
	public function filter_members_only_downloads( $downloads ) {
		...
		// Check both the specific Download Monitor setting and the global Filter Queries setting.
		if ( ! wpf_get_option( 'download_monitor_members_only' ) && ! wpf_get_option( 'hide_archives' ) ) {
			return $downloads;
		}
