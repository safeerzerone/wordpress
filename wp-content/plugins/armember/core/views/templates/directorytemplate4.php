...
if (isset($user) && !empty($user))
{
	...
	$fileContent .= '<div class="arm_user_block '.esc_attr($wrapperClass).'">';
		$fileContent .= '<div class="arm_user_avatar" tabindex="-1">'.$user['profile_picture'].'</div>';
		...
		$fileContent .= '<div class="arm_user_name">'. $arm_shortcodes->arm_com_descaped_all_shortcodes($arm_shortcodes->arm_com_escape_all_shortcodes($user['full_name'])) .'</div>';
