<?php
    ...
    $requested_module = ( ! empty($_REQUEST['page']) && ( $_REQUEST['page'] != 'affiliatepress' ) ) ? sanitize_text_field(str_replace('affiliatepress_', '', wp_unslash($_REQUEST['page']))) : 'dashboard'; // phpcs:ignore

    $affiliatepress_load_file_name = AFFILIATEPRESS_VIEWS_DIR . '/affiliatepress_header.php';
    $affiliatepress_load_file_name = apply_filters('affiliatepress_modify_header_content', $affiliatepress_load_file_name,1);

    if($requested_module != "growth_tools"){
        require $affiliatepress_load_file_name;
    }

    do_action( 'affiliatepress_page_admin_notices' );

    echo '<div class="affiliatepress_page_inner_wrapper" v-cloak>';
        echo '<div class="v-cloak-affiliatepress-hidden">';
            do_action('affiliatepress_' . $requested_module . '_dynamic_view_load');
        echo '</div>';
    echo '</div>';

?>
<div v-cloak class="ap-fab-component">
    <div class="ap-fc__active-box" :class="affiliatepress_fab_floating_btn == 1 ? '__ap-is-active' : ''">
        <div class="ap-fc__item">
            <el-tooltip effect="dark" content="<?php esc_html_e( 'Need Help?', 'affiliatepress-affiliate-marketing' ); ?>" placement="top" open-delay="5">
                <el-button class="ap-btn ap-btn--icon-without-box" @click="open_need_help_url()">
        ...
        <div class="ap-fc__item">
            <el-tooltip effect="dark" content="<?php esc_html_e( 'Feature Requests', 'affiliatepress-affiliate-marketing' ); ?>" placement="top" open-delay="5">
                <el-button class="ap-btn ap-btn--icon-without-box" @click="open_feature_request_url">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="ap-fc__item">
            <el-tooltip effect="dark" content="<?php esc_html_e( 'Facebook Community', 'affiliatepress-affiliate-marketing' ); ?>" placement="top" open-delay="5">
                <el-button class="ap-btn ap-btn--icon-without-box" @click="open_facebook_community_url">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="ap-fc__item">
            <el-tooltip effect="dark" content="<?php esc_html_e( 'YouTube Channel', 'affiliatepress-affiliate-marketing' ); ?>" placement="top" open-delay="5">
                <el-button class="ap-btn ap-btn--icon-without-box" @click="open_youtube_channel_url">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.043 19.307V10.4434L18.4293 14.8752L11.043 19.307Z" fill="#1CC6C9"/>
                    </svg>
                </el-button>
            </el-tooltip>
        </div>
        <div class="ap-ab__close-icon" @click="ap_fab_floating_close_btn">
            <el-button class="ap-btn ap-btn--icon-without-box">
    ...
    <div class="ap-fc__inactive-box">
        <div class="ap-fc__item">
            <el-button class="ap-btn ap-btn--icon-without-box" @click="ap_fab_floating_action_btn">
...
<el-drawer @close="resetNeedHelpModal()" modal-class="ap-help-drawer" :withHeader="false" v-model="needHelpDrawer" :direction="drawer_direction" v-cloak>
    <div class="ap-btn--close-drawer-container">
        <div @click="close_need_help_popup" class="ap-btn--close-drawer">
            <span class="ap-drawer-cose__icon"><i class="el-dialog__close el-icon el-icon-close"></i></span>
        </div>
    </div>      
    <el-container>        
    <div class="ap-help-drawer__body-wrapper">
        <div class="ap-help-close-icon-inside" @click="close_need_help_popup">
            <?php do_action('affiliatepress_common_svg_code' , 'help_close') ;?>
        </div>
        <div class="ap-back-loader-container" v-if="is_display_drawer_loader == '1'">
            <div class="ap-back-loader"></div>
        </div>
        <div class="ap-hd-header">
            <h1 class="ap-page-heading">{{ requested_module }}</h1>
            <el-link :href="read_more_link" :underline="false" target="_blank" class="ap-btn ap-btn__small"><?php esc_html_e('Read more', 'affiliatepress-affiliate-marketing'); ?></el-link>
        </div>
        <div class="ap-hd-body ap_new_single_content" v-html="helpDrawerData"></div>
    </div>
    </el-container>    
</el-drawer>
<el-dialog v-cloak modal-class="ap-affiliate-dialog ap-dialog--upgrade-to-premium" width="700"  v-model="affiliatepress_premium_modal">
<div class="ap-affiliate-dialog">
        <div class="ap-dialog-utp__head-wrap">
            <div class="ap-dialog-utp__head-icon">
                <svg width="41" height="57" viewBox="0 0 41 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M31.9453 35.7148L19.5306 56.1974L16.6155 48.3792L31.9453 35.7148Z" fill="#FFCE00"/>
                    <g clip-path="url(#clip0_2759_2957)">
                    <path d="M5.22125 23.6094L4.87448 12.9579L16.4925 18.6855L18.3036 11.2336L40.7749 25.9414L23.3695 21.8351L20.2912 28.4956L5.22125 23.6094Z" fill="#E61D95"/>
                    </g>
                    <defs>
                    <clipPath id="clip0_2759_2957">
                    <rect width="28.8664" height="30.0903" fill="white" transform="matrix(-0.8468 0.531911 0.531911 0.8468 24.7695 0.460938)"/>
                    </clipPath>
                    </defs>
                </svg>                
            </div>
            <h3><?php esc_html_e('Unlock the Powerful Pro Features', 'affiliatepress-affiliate-marketing'); ?></h3>
            <div class="ap-dialog-utp__head-icon">
                <svg width="35" height="45" viewBox="0 0 35 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.7559 33.7891L34.3706 44.6341L32.6642 36.384L12.7559 33.7891Z" fill="#FFCE00"/>
                    <g clip-path="url(#clip0_2759_2953)">
                    <path d="M28.3975 9.37085L23.2359 0.527344L16.7105 11.1251L11.4285 5.98767L0.662109 29.4386L12.7249 17.2023L18.6335 21.0481L28.3975 9.37085Z" fill="#E61D95"/>
                    </g>
                    <defs>
                    <clipPath id="clip0_2759_2953">
                    <rect width="27.7354" height="28.9113" fill="white" transform="translate(0.662109 0.527344)"/>
                    </clipPath>
                    </defs>
                </svg>                
            </div>
    ...
    <div class="ap-affiliate-dialog-body">
        <div class="ap-utp__body-item-wrap">
            <h4><?php esc_html_e('Setup and Manage Affiliates, with Utmost Ease', 'affiliatepress-affiliate-marketing'); ?></h4>
            <p><?php esc_html_e('To take your business to the next level, explore AffiliatePress Pro. From signup bonus to mass payouts, everything with just a single tool!', 'affiliatepress-affiliate-marketing'); ?></p>            
            <div class="ap-utp__key-features">
                <h5><?php esc_html_e('Exclusive Features', 'affiliatepress-affiliate-marketing'); ?></h5>
                <div class="ap-kf__item-row">
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8.48857" cy="8.13114" r="7.58427" fill="#E4D8FD"/>
                                <circle cx="8.52862" cy="7.90948" r="3.78057" fill="#5012D4"/>
                            </svg>
                        </div>
                        <div class="ap-kf__item-title"><?php esc_html_e('PayPal Mass Payouts', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Custom Affiliate Groups', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Credit Last Referrer ', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Groupwise Commission Rates', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Import/Export Settings', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Advanced Reports', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div> <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8.48857" cy="8.13114" r="7.58427" fill="#E4D8FD"/>
                                <circle cx="8.52862" cy="7.90948" r="3.78057" fill="#5012D4"/>
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Import/Export Affiliates', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Affiliate Form Fields', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('Import/Export Commissions', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                    <div class="ap-kf__item">
                        <div class="ap-kf__item-icon">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ap-kf__item-title"><?php esc_html_e('User-specific Commissions', 'affiliatepress-affiliate-marketing'); ?></div>
                    </div>
                </div>
            </div> 
