...
echo "profile_default_values = '" . wp_json_encode( $profile_fields_data['default_values'] ) . "';";
...
if ( ( isset( $get_action ) && $get_action == 'edit_profile') || (isset($_GET['action']) && $_GET['action'] == 'duplicate_profile') ){ //phpcs:ignore
	...
	$arm_template_title = !empty($data->arm_title) ? stripslashes_deep($data->arm_title) : '';
	$subscription_plans        = ( isset( $data->arm_subscription_plan ) && $data->arm_subscription_plan != '' ) ? explode( ',', $data->arm_subscription_plan ) : array();
	$default_data              = $data;
...
<div class="wrap arm_page arm_profiles_main_wrapper armPageContainer">
	...
	<div class="content_wrapper arm_profiles_directories_container arm_min_height_500 arm_width_100_pct"  id="content_wrapper">
		<!-- <div class="page_title"><?php esc_html_e( 'Profiles & Directories', 'armember-membership' ); ?></div> -->
		<input type="hidden" id="arm_default_profile_data" value='<?php echo esc_attr( wp_json_encode( $default_data ) ); ?>' />
		<form name="arm_add_profile_temp_form" class="arm_add_profile_temp_form" id="arm_add_profile_temp_form" onSubmit="return false;" method="POST" action="#">
			<div class="page_title_wrapper">
				<div class="page_title">
					<?php
						...
						} else if($_GET['action'] == 'duplicate_profile') { //phpcs:ignore
							esc_html_e('Copy Profile Template', 'armember-membership');
						} else {
			...
			<div class="arm_sticky_top_belt" id="arm_sticky_top_belt">
				<div class="arm_belt_box arm_template_action_belt">
					<div class="arm_belt_block">
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . $arm_slugs->profiles_directories ) ); //phpcs:ignore ?>" class="armemailaddbtn"><?php esc_html_e( 'Back to listing', 'armember-membership' ); ?></a>
					</div>
					<div class="arm_belt_block arm_temp_action_btns" align="<?php echo esc_attr( $is_rtl ) ? 'left' : 'right'; ?>">
						<button type="button" class="arm_save_btn arm_add_profile_template_submit" data-type="profile"><?php esc_html_e( 'Save', 'armember-membership' ); ?></button>
					</div>
			...
			<div class="arm_profile_editor_content_wrapper">
				<a href="javascript:void(0)" class="arm_slider_arrow arm_slider_arrow_right arm_profile_editor_left_arrow_right armhelptip" title="<?php esc_html_e( 'Open Settings', 'armember-membership' ); ?>" data-id="arm_profile_editor_left_div"></a>
				<div class="arm_profile_editor_left_div connectedSortable" id="answers">
					<a href="javascript:void(0)" class="arm_slider_arrow arm_slider_arrow_left arm_temp_slider_arrow_left arm_profile_editor_left_arrow_left armhelptip" title="<?php esc_html_e( 'Hide Settings', 'armember-membership' ); ?>" data-id="arm_profile_editor_left_div"></a>
					<div id="arm_accordion">
						<ul>
							
							<li class="arm_profile_accordion_section arm_active_section">
								<a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e('Basic', 'armember-membership'); ?>
									<i></i>
								</a>
								<div id="one" class="arm_accordion default">
									<div class="arm_accordion_inner_title"><?php esc_html_e('Profile Template Name', 'armember-membership'); ?></div>
									<div class="arm_profile_accordion_basic_tab">
										<input type="text" name="arm_profile_template_name" class="arm_form_input_box" value="<?php echo esc_attr($arm_template_title); ?>">                               
									</div>
								</div>
							</li>
							<li class="arm_profile_accordion_section">
								<a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e('Color Scheme', 'armember-membership'); ?>
									<i></i>
								</a>
								<div id="two" class="arm_accordion">
									<div class="arm_profile_settings_accordion arm_profile_color_setting_accordion">
										<div class="arm_profile_color_scheme_div c_schemes">
											...
											<div class="arm_temp_color_options arm_temp_custom_colorpicker_wrapper" id="arm_temp_color_options" style="<?php echo isset( $options['color_scheme'] ) && $options['color_scheme'] == 'custom' ? 'display:block' : 'display:none'; ?>">
												...
												<div class="arm_temp_color_option_footer arm_text_align_right">
							...
							<li class="arm_profile_accordion_section">
								<a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e('Font Settings', 'armember-membership'); ?>
									<i></i>
								</a>
								<div id="three" class="arm_accordion">
									<div class="arm_profile_settings_accordion arm_proflie_font_setting_accordion">
										<div class="arm_profile_font_settings_inner_div">
											<?php
											$fontOptions = array(
											...
											$fontOptions_count = count($fontOptions);
											$fontOptions_count_index = 1;
											if($profile_template == '6'){
												$font_family = 'Poppins';
											...
											<?php foreach ( $fontOptions as $key => $value ) : ?>
												<div class="arm_temp_font_opts_box">
													...
													<div class="arm_temp_font_opts">
														...
														<div class="arm_temp_font_opts_wrapper">
															...
															<dl class="arm_selectbox column_level_dd arm_profile_font_size_select">
															...
															<div class="arm_font_style_options arm_template_font_style_options">
																...
																?>
																<label class="arm_font_style_label arm_margin_right_8 <?php echo esc_attr($bold_cls); ?>" data-value="bold" data-field="arm_template_font_bold_<?php echo esc_attr($key); ?>"><i class="armfa armfa-bold"></i></label>
																...
																<label class="arm_font_style_label arm_margin_right_8 <?php echo esc_attr($italic_cls); ?>" data-value="italic" data-field="arm_template_font_italic_<?php echo esc_attr($key); ?>"><i class="armfa armfa-italic"></i></label>
																...
																<label class="arm_font_style_label arm_margin_right_8 arm_decoration_label <?php echo esc_attr($underline_cls); ?>" data-value="underline" data-field="arm_template_font_decoration_<?php echo esc_attr($key); ?>"><i class="armfa armfa-underline"></i></label>
												...
												<?php if ($fontOptions_count_index <= ($fontOptions_count - 1)) { ?>
													<div class="arm_accordion_separator_double"></div>
												<?php }
												$fontOptions_count_index++; ?>
											<?php endforeach; ?>
							...
							<?php  ?>
							<li class="arm_profile_accordion_section">
								<a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e('Select Template', 'armember-membership'); ?>
									<i></i>
								</a>
								<div id="four" class="arm_accordion">
									<div class="arm_profile_settings_accordion arm_proflie_template_setting_accordion">
									<?php
										if($ARMemberLite->is_arm_pro_active) {
											$arm_additional_form_belt_actions = '';
											echo apply_filters('arm_profile_directories_additional_popup_action',$arm_additional_form_belt_actions,$profile_templates,$temp_slug); //phpcs:ignore
										} else {
									?>
							...
							<li class="arm_profile_accordion_section">
								<a href="javascript:void(0)" class="arm_accordion_header" onclick="arm_init_custom_css_codemirror_editor();"><?php esc_html_e('Custom CSS', 'armember-membership'); ?>
								<!-- <a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e('Custom CSS', 'armember-membership'); ?> -->
									<i></i>
								</a>
								<div id="five" class="arm_accordion">
									<div class="arm_profile_settings_accordion arm_proflie_template_custom_css_accordion">
										<?php
											$arm_profile_editor_css_section = '';
											echo apply_filters('arm_profile_editor_css_section',$arm_profile_editor_css_section,$options); //phpcs:ignore
										?>
									</div>
								</div>
							</li>
				...
				<div class="arm_profile_editor_middle_div">
					<div class="arm_profile_belt">
						...
						<div class="arm_profile_belt_icon_separator"></div>
				...
				<a href="javascript:void(0)" class="arm_slider_arrow arm_slider_arrow_left arm_profile_editor_right_arrow_left armhelptip hidden_section" title="<?php esc_html_e( 'Open Settings', 'armember-membership' ); ?>" data-id="arm_profile_editor_right_div"></a>
				<div class="arm_profile_editor_right_div connectedSortable" id="answers">
					<a href="javascript:void(0)" class="arm_slider_arrow arm_slider_arrow_right arm_temp_slider_arrow_right arm_profile_editor_right_arrow_right armhelptip" title="<?php esc_html_e( 'Hide Settings', 'armember-membership' ); ?>" data-id="arm_profile_editor_right_div"></a>
					<div id="arm_accordion">
						<ul>
							<?php $arm_active_class_lite = '';
							$class_css = "display:none;";
							if(!$ARMemberLite->is_arm_pro_active)
							{
								$arm_active_class_lite = 'arm_active_section';
								$class_css = '';
							}
							else{?>
							<li class="arm_profile_accordion_section arm_active_section">
								<a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e('Add New Block', 'armember-membership'); ?>
									<?php $gf_tooltip = esc_html__("You can add specific HTML before/after profile fields listing section", 'armember-membership'); ?>
									<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_attr($gf_tooltip); ?>"></i>
									<i></i></a>
								<div id="one" class="arm_accordion default">
									<div class="arm_accordion_inner_title"><?php esc_html_e('Before profile fields', 'armember-membership'); ?></div>
									<?php
									$content = "";
									...
									<div class="arm_accordion_inner_title arm_margin_top_20" ><?php esc_html_e('After profile fields', 'armember-membership'); ?></div>
									<?php
									$content = "";
							...
							<?php } ?>
							<li class="arm_profile_accordion_section <?php echo esc_attr($arm_active_class_lite);?>">
								<a href="javascript:void(0)" class="arm_accordion_header"><?php esc_html_e( 'Profile Fields', 'armember-membership' ); ?>
									...
									<i></i></a>
								<div id="two" class="arm_accordion default" data-id="arm_profile_fields_wrapper" style="<?php echo esc_attr($class_css);?>">
									<div class="arm_profile_fields_dropdown">
										<input type="hidden" id="arm_profile_fields" class="arm_profile_fields" value="0" />
										<dl class="arm_selectbox column_level_dd" style="width:100%;">
											<dt>
												<span><?php esc_html_e( 'Select Field', 'armember-membership' ); ?></span><!-- <i class="arm_add_profile_field_icon"></i> -->
												<input type="text" style="display:none;" class="arm_autocomplete arm_profile_fields_readonly" readonly="readonly" />
												<i class="arm_add_profile_field_icon"></i>
											</dt>
											<dd>
												<ul data-id="arm_profile_fields" style="display: none;">
													<li data-label="<?php esc_attr_e( 'Select Field', 'armember-membership' ); ?>" data-value="0"><?php esc_attr_e( 'Select Field', 'armember-membership' ); ?></li>
													<?php
									...
									<div class="arm_accordion_inner_container" id="arm_profile_fields_inner_container">
										...
										foreach ( $profile_fields_data['profile_fields'] as $k => $pf ) {
											...
											<div class="arm_add_profile_shortcode_row arm_user_custom_meta" id="arm_add_profile_shortcode_<?php echo esc_attr($pf); ?>">
												<div class="arm_add_profile_variable_code arm_add_profile_user_meta" data-code="<?php echo esc_attr($pf); ?>">
													<?php 
													if($ARMemberLite->is_arm_pro_active)
													{
													
																			if($pf=='arm_profile_membership_plan')
																			{
																				$profile_fields_data['label'][$pf] = !isset($profile_fields_data['label'][$pf]) ? esc_html__("Membership Plan","armember-membership") : $profile_fields_data['label'][$pf];
																			}
																			else if($pf=='arm_profile_membership_plan_expiry_date')
																			{
																				$profile_fields_data['label'][$pf] = !isset($profile_fields_data['label'][$pf]) ? esc_html__("Plan Expiry Date","armember-membership") : $profile_fields_data['label'][$pf];
																			}
																			else if($pf=='arm_profile_membership_plan_renew_date')
																			{
																				$profile_fields_data['label'][$pf] = !isset($profile_fields_data['label'][$pf]) ? esc_html__("Plan Renewal Date","armember-membership") : $profile_fields_data['label'][$pf];
																			}
													}
													if(!empty($profile_fields_data['label'][ $pf ])){
														$profile_fields_data['label'][ $pf ] = htmlspecialchars($profile_fields_data['label'][ $pf ], ENT_QUOTES);
													}
													?>
												...
												<div class="arm_add_profile_field_icons">
											...
											<?php echo $arm_global_settings->arm_get_confirm_box( $pf, esc_html__( 'Are you sure you want to delete this field?', 'armember-membership' ), 'arm_remove_profile_shortcode_row' ,'',esc_html__("Delete", 'armember-membership'),esc_html__("Cancel", 'armember-membership'),esc_html__("Delete", 'armember-membership')); //phpcs:ignore ?>
											</div>    
											<?php
										}
										?>
							...
							<li class="arm_profile_accordion_section arm_social_profile_fields_accordion_section">
								...
								<div id="three" class="arm_accordion"> 
									...
									foreach ( $socialProfileFields as $SPFKey => $SPFLabel ) {
										...
										<div class='arm_social_profile_field_item'>
											...
											<label for='arm_spf_<?php echo esc_attr($SPFKey); ?>_status' class="arm_margin_left_10"><?php echo esc_attr($SPFLabel); ?></label>
										</div>
										<?php
									}
									?>
							...
							<li class="arm_profile_accordion_section">
								...
								<div id="five" class="arm_accordion">
									<div class="arm_profile_other_settings">
										...
										<?php
										$arm_profile_additional_other_settings_options='';
										echo apply_filters('arm_profile_additional_other_settings_options',$arm_profile_additional_other_settings_options,$display_member_badges); //phpcs:ignore
										?>
										...
										<div class="arm_profile_setting_switch_div"><label for="arm_profile_display_cover_image"><?php esc_html_e( 'Default Cover Image', 'armember-membership' ); ?></label>
											...
											<div class="arm_profile_setting_switch_div" id="arm_profile_upload_buttons_div" style="<?php echo ( $default_cover_photo != 1 ) ? 'display:none;' : ''; ?>">
												...
												<div class="arm_default_cover_photo_wrapper" style="<?php echo ( $show_remove_cover_photo ) ? 'display:none' : 'display:inline-block'; ?>">
													...
													<input type="file" data-update-meta='no' class="arm_accordion_file_upload_button armFileUpload" data-avatar-type="cover" id='armTempEditFileUpload' accept=".jpg,.jpeg,.png,.bmp,.ico" data-type="profile" />
												</div>
		...
		<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"><?php //phpcs:ignore ?>    
	</div>
...
<div id="arm_crop_cover_div_wrapper" class="arm_crop_cover_div_wrapper" style="display:none;">
    ...
    <div id="arm_crop_cover_div">
        <img id="arm_crop_cover_image" class="arm_max_width_100_pct arm_max_height_100_pct" src=""  /> <?php //phpcs:ignore ?>
    </div>
...
<div id="arm_crop_div_wrapper" class="arm_crop_div_wrapper" style="display:none;">
    ...
    <div id="arm_crop_div">
        <img id="arm_crop_image" src="" class="arm_max_width_100_pct" /> <?php //phpcs:ignore ?>
    </div>
